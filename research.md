  ...
  <div class="col-md-8">
    ...
    <div class="bg-white p-4 border rounded shadow-sm">
      ...
      <ul class="list-unstyled mb-0" style="line-height: 1.8; font-size: 1.05rem;">
        ...
        <li class="mb-3">
          <strong>Sweat Gland Biophysics:</strong> Ground-up physiological quantization (
        ...
        <li class="mb-3">
          <strong>Artifact Mitigation:</strong> Automated real-time EDA correction arrays inside clinical ORs (
        ...
        <li class="mb-3">
          <strong>State Classification:</strong> Parsing clean sleep vs. wake metrics from raw accelerometer dynamics (
...
<style>
  /* Color Variables & Base Typography */
  ...
  /* Substantial Body Text Settings */
  .project-text-main { font-size: 1.1rem; line-height: 1.6; color: #111111; font-weight: 500; }

  /* Structure Cards Configuration */
  .project-card { position: relative; padding: 22px 24px 18px 24px; border-radius: 8px; border-left: 6px solid #ccc; margin-top: 15px; box-shadow: 0 4px 6px rgba(0,0,0,0.02); }
