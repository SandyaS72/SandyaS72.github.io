...
sizes="(min-width: 1501px) calc(8vw - 20px), ((min-width: 1101px) and (max-width: 1500px)) calc(19vw - 20px), ((min-width: 651px) and (max-width: 1100px)) calc(36vw - 20px), ((min-width: 300px) and (max-width: 650px)) calc(46vw - 20px), 150px"
alt="ANS network">
