...
sizes="(min-width: 1501px) calc(15vw - 20px), ((min-width: 1101px) and (max-width: 1500px)) calc(25vw - 20px), ((min-width: 651px) and (max-width: 1100px)) calc(35vw - 20px), ((min-width: 300px) and (max-width: 650px)) calc(45vw - 20px), 150px"
...
sizes="(min-width: 1501px) calc(25vw - 20px), ((min-width: 1101px) and (max-width: 1500px)) calc(35vw - 20px), ((min-width: 651px) and (max-width: 1100px)) calc(55vw - 20px), ((min-width: 300px) and (max-width: 650px)) calc(70vw - 20px), 150px"
alt="Autonomic nervous system word cloud">

### Our Envisioned Impact Continuum

Monitoring and modeling the ANS can lead to a wide range of impacts 
